...
# The root mean squared errors are respectively: 0.46, 0.72, 0.54, 0.58 and 0.34. Resulting in a mean of 0.53.
...
# Resulting in root mean squared errors of respectively 0.37, 0.82, 0.54, 0.57 and 0.31. The mean of these errors is 0.5. That is, a bit smaller error than for the baseline model, but not much.
...
# Resulting in root mean squared errors of respectively 0.38, 0.60, 0.35, 0.54 and 0.38. The mean of these errors is 0.45. That is again, a smaller error than for the baseline model, and also smaller than the model including only a two-way interaction.
```
