...
print(pc_30_Visit)
plot(pc_30_Visit)
# With 30 participants, the power for the main effect of "Visit" is 100%.
...
# With 30 participants, the power for the main effect of "Diagnosis" is 11%.

# Interaction effect
pc_30_inter <- powerCurve(model, test = fixed("Visit:Diagnosis"), along = "Child.ID", nsim = 100, breaks = seq(from = 1, to = 32, by = 2), seed = 1)
print(pc_30_inter)
plot(pc_30_inter)
# With 30 participants, the power for the interaction effect is 47%.
...
powvis_30
# 100% power for detecting effect of visit (nsim = 100)

powdiag_30 <- powerSim(model0_30, test = fixed("Diagnosis"), nsim = 100, seed = 1)
powdiag_30
# 72% power for detecting effect of diagnosis (nsim = 100)

# On the interaction effect
powinter_30 <- powerSim(model_30, test = fixed("Visit:Diagnosis"), nsim=100, seed = 1)
powinter_30
# 88% power for detecting the three-way interaction effect (nsim = 100)
