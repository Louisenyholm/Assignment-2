...
#Verbal IQ - most obvious. How do we figure out if verbal IQ, non-verbal IQ and socialisation?
# MLU ~ VISIT * DIAGNOSIS + VIQ (Calculates VIQ as a main effect - if the others are 0, bla bla)
# MLU ~ VISIT * DIAGNOSIS + (VIQ*VISIT) (givin your initial viq, your speed of learning might change, assuming that VIQ and DIAGNOSIS are independent...)
# Plot the data to look at viq in TD and ASD group individually...
# MLU ~ VISIT * DIAGNOSIS * VIQ ???
